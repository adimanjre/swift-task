        ...
        <div className= "container p-5" >
            ...
            <div className = "container d-flex gap-4 justify-content-center mt-5 mb-5" >
                <Link href="/help/getting-started/Getting-started-guides">
                    <div className={Help.mainTopic}>
                        <Image />
                        <h1 className={Help.mainTopicHeading}> Getting Started </h1>
                    </div>
                </Link>
                <Link href="/help/use-swift-tasks/Getting-started-guides">
                    <div className={Help.mainTopic}>
                        <Image />
                        <h1 className={Help.mainTopicHeading}> Use Swift Tasks </h1>
                    </div>
                </Link>
            </div>
