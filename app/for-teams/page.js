...
import teamTasks from '@/public/img/team-tasks.png'
import productivity from '@/public/img/productivity.png'
import clarity from '@/public/img/clarity.png'
import collaboration from '@/public/img/team-collabration.png'
import projectSuccess from '@/public/img/project-sucess.png'
            ...
            <div>
                ...
                <div className="container mt-5">
                    <div className="row mt-5 align-items-center">
                        ...
                        <div className="col-6">
                            <Image src={teamTasks} alt="team tasks" className="img-fluid" />
                        </div>
                    </div>
                    <div className="row mt-5 align-items-center">
                        <div className="col-6">
                            <Image src={productivity} alt="productivity" className="img-fluid" />
                        </div>
                        <div className="col-6 p-5">
                    ...
                    <div className="row mt-5 align-items-center">
                        ...
                        <div className="col-6">
                            <Image src={clarity} alt="clarity" className="img-fluid" />
                        </div>
                    </div>
                    <div className="row mt-5 align-itmes-center">
                        <div className="col-6">
                            <Image src={collaboration} alt="collaboration" className="img-fluid" />
                        </div>
                        <div className="col-6 p-5">
                    ...
                    <div className="row mt-5 align-items-center">
                        ...
                        <div className="col-6">
                            <Image src={projectSuccess} alt="project-success" className="img-fluid" />
                        </div>
                    </div>
                </div>
